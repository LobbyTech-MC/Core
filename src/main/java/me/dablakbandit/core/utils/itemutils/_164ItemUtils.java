...
public class _164ItemUtils implements IItemUtils{
	...
	public Object getRegistry(){
		try{
			return NMSUtils.getPossibleField(ni, "REGISTRY", "field_150901_e").get(null);
		}catch(Exception e){
		}
		return null;
	}
	
	public Class<?>	nmrs	= NMSUtils.getPossibleClass("net.minecraft.util.registry.RegistrySimple", "net.minecraft.util.RegistrySimple");
	...
	public Constructor<?>	nbtbc	= NMSUtils.getConstructorSilent(nbtby, String.class, byte.class);
	public Constructor<?>	nbtbac	= NMSUtils.getConstructorSilent(nbtba, String.class, byte[].class);
	public Constructor<?>	nbtdc	= NMSUtils.getConstructorSilent(nbtd, String.class, double.class);
	public Constructor<?>	nbtfc	= NMSUtils.getConstructorSilent(nbtf, String.class, float.class);
	public Constructor<?>	nbtic	= NMSUtils.getConstructorSilent(nbti, String.class, int.class);
	public Constructor<?>	nbtiac	= NMSUtils.getConstructorSilent(nbtia, String.class, int[].class);
	public Constructor<?>	nbtlc	= NMSUtils.getConstructorSilent(nbtl);
	public Constructor<?>	nbtloc	= NMSUtils.getConstructorSilent(nbtlo, String.class, long.class);
	public Constructor<?>	nbtsc	= NMSUtils.getConstructorSilent(nbts, String.class, short.class);
	public Constructor<?>	nbtstc	= NMSUtils.getConstructorSilent(nbtst, String.class, String.class);
	...
	public Object getAttribute(Object compound) throws Exception{
