...
public enum EnchantmentFixer{
	...
	SWEEPING(22), EFFICIENCY(32), SILK_TOUCH(33), UNBREAKING(34), FORTUNE(35), POWER(48), PUNCH(49), FLAME(50), INFINITY(51), LUCK_OF_THE_SEA(61), LURE(62), MENDING(70), VANISHING_CURSE(71);
