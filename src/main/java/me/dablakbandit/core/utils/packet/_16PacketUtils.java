...
public class _16PacketUtils implements IPacketUtils {

    private static _16PacketUtils instance = new _16PacketUtils();

    public static _16PacketUtils getInstance() {
        return instance;
    }
    ...
    public static class Animation {
        ...
        public static Object getPacket(Entity entity, int i) throws Exception {
            return constructorPacketPlayOutAnimation.newInstance(getInstance().getHandle(entity), i);
        }
    ...
    public static class Chat {
        ...
        public static byte getByte(Object packet) throws Exception {
            ...
            if (o.getClass().equals(classChatMessageType)) {
                return (byte) ((Enum) o).ordinal();
            }
            return (byte) o;
        }
    }
    ...
    public static class PlayerInfo {
        ...
        public static Object getRemovePacket(Player player) {
            try {
                Object ep = getInstance().getHandle(player);
    ...
    public static class OpenWindow {
        ...
        private static Constructor<?> getConContainerAnvil() {
            if (classContainers != null) {
                return getConstructorSilent(classContainerAnvil, int.class, NMSUtils.getNMSClass("PlayerInventory"), classContainerAccess);
            }
            if (classBlockPosition != null) {
                return getConstructorSilent(classContainerAnvil, NMSUtils.getNMSClass("PlayerInventory"), classWorld, classBlockPosition, classEntityHuman);
            }
        ...
        public static void openAnvil(Player player) {
            try {
                ...
                getInstance().sendPacket(player, getAnvilPacketPlayOutOpenWindow(c));
