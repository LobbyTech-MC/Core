...
public abstract class FastBase{
	...
	protected static Method		world_method_s							= NMSUtils.getMethod(nms_world_class, new String[]{ "n", "s" }, nms_block_position_class);
	protected static Method		world_method_c							= NMSUtils.getMethod(nms_world_class, new String[]{ "d", "c" }, int.class, int.class);
	...
	protected static Method		world_get_chunk_provider_server			= NMSUtils.getMethod(nms_world_server_class, new String[]{ "getChunkProvider", "getChunkProviderServer" });
	...
	static{
		if(chunk_b.getReturnType() != int.class){
			chunk_b = NMSUtils.getMethod(nms_chunk_class, "a", nms_height_map_type, int.class, int.class);
		}
	}
